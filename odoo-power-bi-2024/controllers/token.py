...
from odoo.addons.api_restful_odoo.common import invalid_response, valid_response
from odoo.http import request
from odoo.exceptions import AccessError, AccessDenied

_logger = logging.getLogger(__name__)

expires_in = "api_restful_odoo.access_token_expires_in"
...
class AccessToken(http.Controller):
    ...
    @http.route("/api/login", methods=["POST"], type="http", auth="none", csrf=False,cors='*')
    def token(self, **post):
    ...
    @http.route("/api/logout", methods=["DELETE"], type="http", auth="none", csrf=False,cors='*')
